...
export const BackgroundGradient = ({ hideOverlay, ...props }: any) => {
  ...
  let fallbackBackground = `radial-gradient(at top left, ${colors[0]} 100%, transparent 80%), radial-gradient(at bottom, ${colors[1]} 30%, transparent 60%), radial-gradient(at bottom left, var(--chakra-colors-cyan-500) 0%, transparent 50%),
